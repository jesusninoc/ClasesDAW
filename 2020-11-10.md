...
$_GET
vector
Almacena las variables que se pasan desde un formulario mediante el método GET
$_POST
vector
Almacena las variables que se pasan desde un formulario mediante el método POST
$_COOKIE
vector
Guarda los valores que están almacenados en cookies         
$_SESSION
vector
Guarda las variables que se pasan entre sesiones
$_SERVER
vector
Contiene numerosos valores relativos al servidor
$_FILES
tabla
Almacena información de los ficheros que se pasan desde un formulario.
